...
describe(PhotoBoardComponent.name, () => {
  ...
  it(`Should display rows and columns when (@Input photos has value)`, () => {
    ...
    // No teste, ngOnChanges não chama, só chama se propriedade é referenciada em template de outro component
    // Outra forma de trabalhar com ngOnChanges no outro arquivo de teste
