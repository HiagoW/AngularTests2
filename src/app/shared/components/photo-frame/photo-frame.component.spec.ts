...
describe(PhotoFrameComponent.name, () => {
  ...
  it(`#${PhotoFrameComponent.prototype.like.name}
    ...
    multiple times within debounce time`, fakeAsync(() => {
      // Disparar ciclo de vida do componente
  ...
  it(`#${PhotoFrameComponent.prototype.like.name}
    ...
    it(`(D) Should display number of likes when (@Input likes) is incremented`, () => {
      fixture.detectChanges();
      component.likes++;
      // Deve chamar detectChanges de novo para angular redesenhar no DOM
      fixture.detectChanges();
      // nativeElement = elemento do dom que corresponde a instancia do componente
